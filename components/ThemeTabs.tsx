                ...
                <View className="z-10">
                    {type === 'scrollview' ? (
                        <ScrollView 
                            ...
                            horizontal 
                            className='flex-row h-[48px] bg-background dark:bg-dark-primary border-b border-light-secondary dark:border-white/20'
                        >
                            {tabs.map((tab, index) => {
                        ...
                        <View className='flex-row h-[48px] bg-background dark:bg-dark-primary border-b border-light-secondary dark:border-white/20'>
                            {tabs.map((tab, index) => {
                                if (!React.isValidElement(tab)) return null;
                                return (
                                    <Animated.View
